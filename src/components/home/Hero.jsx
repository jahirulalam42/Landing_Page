  ...
  return (
    <div className="min-h-fit bg-black relative z-0">
      ...
      <div className="text-gray-50 flex flex-col gap-4 py-8 md:py-16 relative z-10 px-4">
        ...
        <button className="btn btn-ghost slow-glow-button bg-gradient-to-r from-blue-400 to-blue-950 text-white border-0 hover:from-blue-950 hover:to-blue-400 shadow-md text-sm md:text-lg">
