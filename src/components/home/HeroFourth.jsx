  ...
  return (
    <div className="min-h-fit bg-zinc-900 flex flex-col items-center justify-center py-20">
      ...
      <div className="bg-gradient-to-r from-lightBlue to-blue-900 w-11/12 md:w-4/6 h-auto md:h-96 rounded-3xl flex flex-col md:flex-row justify-between items-center p-6 md:p-12 shadow-lg">
        ...
        <div className="flex-1 text-center md:text-left mb-6 md:mb-0">
          <div className="p-4 md:p-8">
            ...
            <h2 className="text-3xl md:text-4xl font-bold leading-tight text-gray-50 mb-6">
      ...
      <div className="max-w-6xl mx-auto text-center py-16 px-4">
        <h2 className="text-4xl font-bold text-gray-50 mb-8">By the Numbers</h2>
        ...
        <div className="flex flex-wrap justify-center gap-8 md:gap-16 items-center">
          {[
            ...
            <div
              key={index}
              className="bg-gradient-to-r from-gray-800 to-gray-900 p-4 rounded-xl shadow-md text-center w-40 h-40 flex flex-col justify-center items-center transition-transform transform hover:scale-105 duration-300"
            >
